...
HapticPattern_initWithEvents :: proc "c" (self: ^HapticPattern, events: ^NS.Array, parameters: ^NS.Array, error: ^^NS.Error) -> ^HapticPattern {
	return msgSend(^HapticPattern, self, "initWithEvents:parameters:error:", events, parameters, error)
}
...
HapticEvent_initWithEventType :: proc "c" (
	...
	return msgSend(^HapticEvent, self, "initWithEventType:parameters:relativeTime:duration:", event_type, parameters, relative_time, duration)
}
...
HapticEventParameter_initWithParameterID :: proc "c" (self: ^HapticEventParameter, parameter_id: EventParameterID, value: f32) -> ^HapticEventParameter {
